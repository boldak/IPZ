...
* Прапор `--save` дозволяє встановити пакет і додати запис про нього в розділ 	 файлу package.json, який описує залежності проекту. Після виходу npm 5 записи про встановлювані пакети в розділі залежностей робляється автоматично, і без використання цього прапора.
